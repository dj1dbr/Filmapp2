...
const ScriptInput = ({ screenplay, onScriptChange, disabled, onOpenSettings }) => {
  ...
  return (
    <div className="bg-slate-900/50 backdrop-blur-sm border border-slate-800/50 rounded-2xl p-6 shadow-2xl transition-all duration-300 hover:shadow-indigo-500/10">
      {/* Settings Button - Above everything */}
      <div className="flex justify-end mb-4">
        <button
          onClick={onOpenSettings}
          className="px-4 py-2 bg-slate-800/50 hover:bg-slate-700/50 border border-slate-700 rounded-lg text-sm text-slate-300 transition-colors duration-200 flex items-center gap-2"
